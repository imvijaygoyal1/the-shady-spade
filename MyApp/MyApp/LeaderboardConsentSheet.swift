    ...
    var body: some View {
        VStack(spacing: 0) {
            VStack(spacing: 16) {
                ...
                Text("If you allow, The Shady Spade uploads your chosen player name, avatar, game mode, bids, scores, and round result to our Firebase server so your stats can appear on the global leaderboard. If you do not allow, you can still play and your scores will not be uploaded.")
